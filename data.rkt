...
#lang rosette
                                                      ...
                                                      (define-synthax(gen-expression (booleanvariables ...) (integervariables ...) (integerconstants ...) height)
                                                        ...
                                                        ) (define-symbolic a boolean?) (define-symbolic b boolean?) (define (gen a b) (gen-expression (a b) () () 1)) (syntax->datum (car (generate-forms (synthesize #:forall (list a b) #:guarantee (assert (eq? (or a b) (gen a b))))))) ;)